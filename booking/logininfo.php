 ...
 ?> 
           ...
           <h1 style="display: inline-block;">Login</h1>
                      ...
                      <form action="<?php echo  WEB_ROOT."login.php" ?>" method="post">
                        ...
                        <button type="submit" name="gsubmit" class="button">
                        <a style="display: inline-block;" href="personalinfo.php" data-title="Register New Guest" data-toggle="lightbox">register </a> </button> 
                        </form>   
