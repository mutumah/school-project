...
<title><?php echo isset($title) ? $title . ' | Lieu Online Booking' :  'Lieu Booking' ; ?></title>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Lieu Booking
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          From
          <address>
            <strong>Lieu Booking </strong><br>
            Kimathi street <br>
            Nairobi 94107<br>
            Phone: 0728005459 <br>
            Email: Lieubooking@gmail.com
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
