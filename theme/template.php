...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <!-- Logo -->
      <div class="logo"><a href="#"><img class="logo_1" src="<?php echo WEB_ROOT;?>images/logo24.png" alt=""><img class="logo_2" src="<?php echo WEB_ROOT;?>images/logo24.png" alt=""><img class="logo_3" src="<?php echo WEB_ROOT;?>images/logo24.png" alt=""></a></div>
  ...
  <div class="logo_overlay">
    <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
      <div class="logo"><a href="#"><img src="<?php echo WEB_ROOT;?>images/logo23.png" alt=""></a></div>
    </div>
  </div>
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      <div class="home_title"><h1>Book Your Dream Venue Now!</h1></div>
    ...
    <div class="container">
      <div class="row">
        <div class="col">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Address:</div>
                    <div>kimathistr, no 24,Nairobi</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Mail:</div>
                    <div>lieuhotels@contact.com</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <p> All Rights reserved Lieu booking</p></div>
        </div>
      </div>
    </div>
  </footer>
